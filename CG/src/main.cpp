...
int main()
{
	...
	//radius = 70.0f
	//Angle 0.008f
	Planet mercury = Planet(shader, mercuryModel, 70.0f, 0.01f, 8.0f, 1000.0f, 0.008f, empthyList);
	////Venus
	//radius = 80.0f
	//angle = 0.007f
	Planet venus =Planet(shader, venusModel, 80.0f, 0.01f, 8.0f, 1000.0f, 0.007f, empthyList);
	////earth
	//radius = 90.0f
	//angle = 0.006f
	Planet earth =Planet(shader, earthModel, 90.0f, 0.002f, 8.0f, 1000.0f, 0.006f, earthMoon);
	////Mars
	//radius = 100.0f
	//angle = 0.005f
	Planet mars = Planet(shader, marsModel, 100.0f, 0.01f, 8.0f, 1000.0f, 0.005f, empthyList);
	//// JUPITER
	//radius = 120.0f
	//angle = 0.0045f
	Planet jupiter = Planet(shader, jupiterModel, 120.0f, 0.01f, 8.0f, 1000.0f, 0.0045f, empthyList);
	////Uranus
	//radius = 190.0f
	//angle = 0.0035f
	Planet uranus = Planet(shader, uranusModel, 190.0f, 0.01f, 8.0f, 1000.0f, 0.0035f, empthyList);
	////SATURN
	//radius = 160.0f
	//angle = 0.0040f
	Planet saturn = Planet(shader, saturnModel, 160.0f, 0.01f, 8.0f, 1000.0f, 0.004f, empthyList);
	//radius = 220.0f
	//angle = 0.003f
	Planet neptune = Planet(shader, neptuneModel, 220.0f, 0.01f, 8.0f, 1000.0f, 0.003f, empthyList);
